 ...
 * Задание: Написать код, который выводит на экран в первой строке через пробел значения входящих переменных,
 * во второй ― сумму этих переменных, в третьей - произведение этих переменных.
